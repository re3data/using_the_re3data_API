...
#incase if you don't know what is the exact subject name, please check following links 
...
extract_info <- function(url) {
  ...
  institutionCountry = paste(unique(xml_text(xml_find_all(repository_metadata_XML, "//r3d:institutionCountry"))),collapse="|"),#repositories:institutionCountry,1:many relationship
